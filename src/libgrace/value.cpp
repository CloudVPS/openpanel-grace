...
value::value (value *v)
{
	...
	// We will delete the original object so we can steal its array
	// and name c-string without copying.
	...
	// Unlink the arrays from the original so the destructor won't
	// kill them under our feet.
